...
// Concurrency Control
/***********************************************/
// WAIT_DIE, NO_WAIT, DL_DETECT, TIMESTAMP, MVCC, HEKATON, HSTORE, OCC, OCC_RESERVE/AET_RESERVE, AET_OCC, AET_HYBRID_RULE, AET_HYBRID_SILO, AET_HYBRID_CC, VLL, TICTOC, SILO
...
#define AET_HYBRID_CC				16
#define IS_AET_CC					(CC_ALG == OCC_RESERVE || CC_ALG == AET_OCC || CC_ALG == AET_HYBRID_RULE || CC_ALG == AET_HYBRID_SILO || CC_ALG == AET_HYBRID_CC)
#define IS_SILO_CC					(CC_ALG == SILO || CC_ALG == AET_HYBRID_SILO)
#define IS_AET_HYBRID_CC				(CC_ALG == AET_HYBRID_CC)
#define IS_OCC_AET					(IS_AET_CC && !IS_SILO_CC && !IS_AET_HYBRID_CC)
//Isolation Levels 
